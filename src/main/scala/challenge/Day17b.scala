...
object Day17b extends Challenge {
  ...
  def bfs(start: Point, goal: Point): List[List[Char]] = {
    ...
    while (queue.nonEmpty) {
      ...
      val neighbors = nextPoints(point, dirs)
